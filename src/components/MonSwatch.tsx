...
// Màu của một môn = màu Gú chọn (meta.color) nếu có, không thì suy từ tên (hash ổn định).
// Export để gáy sách (Home tủ-sách) dùng ĐÚNG màu avatar hiện có — nhất quán một nguồn.
export function monColor(name: string, explicit?: string): string {
