...
| Local | 0.3 MB | 20–28 | |
| **Cloud (Drive)** | _(chưa đo)_ | _(chưa đo)_ | cần tài khoản Google + file Drive thật qua picker |

**Wall-clock import LÔ local (đo tay overlay "Đang nhập…", v1.9.0, 2 máy):**

| Máy | Số file | Thời gian | ~ms/file |
|---|---|---|---|
| Z Fold 3 | 30 | 7 s | ~233 |
| Z Fold 3 | 10 | 5 s | ~500* |
| Z Flip 4 | 30 | 4–5 s | ~150 |
| Z Flip 4 | 13 | 2–3 s | ~190 |

*lần 10-file có kèm tạo thư mục mới lúc thêm (không tách được). Đo từ lúc bấm "select" ở picker → overlay tắt.
